...
const CryptoDetails = () => {
  ...
  const genericStats = [
    ...
    { title: 'Total Supply', value: (cryptoDetails.supply.total == null) ? '-' : `$ ${millify(cryptoDetails.supply.total)}`, icon: <ExclamationCircleOutlined /> },
  ...
  return (
    <Col className='coin-detaill-container'>
